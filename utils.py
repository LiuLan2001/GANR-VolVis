...
def dataset_selection(dataset, spatial, temporal):
    if dataset == 'fivejets':
        ori_dim = [128, 128, 128]
        total_samples = 100
        data_path = './dataset/fivejets/down/' 
        if spatial == 2: #SSR
            total_samples = 1
            downsample_factor = 1
        elif spatial == 1:
            data_path = './dataset/fivejets/' 
            downsample_factor = 4
    elif dataset == 'vortex':
        ori_dim = [128, 128, 128]
        total_samples = 1
        if spatial == 2 and temporal == 0:
            data_path = './dataset/vortex/down/' 
            downsample_factor = 1
        elif spatial == 1:
            data_path = './dataset/vortex/' 
            downsample_factor = 4
    elif dataset == 'h2':
        ori_dim = [600, 248, 248]
        total_samples = 1
        if spatial == 2:
            data_path = './dataset/h2/down/' 
            downsample_factor = 8
        elif spatial == 1:
            data_path = './dataset/h2/' 
            downsample_factor = 32
    elif dataset == 'T':
        ori_dim = [600, 248, 248]
        total_samples = 1
        if spatial == 2:
            data_path = './dataset/T/down/' 
            downsample_factor = 8
        elif spatial == 1:
            data_path = './dataset/T/' 
            downsample_factor = 32
        elif spatial == 4:
            data_path = './dataset/T/down/four/' 
            downsample_factor = 1 
        elif spatial == 8:
            data_path = './dataset/T/down/eight/' 
            downsample_factor = 1             
    elif dataset == 'tangaroa':
        ori_dim = [300, 180, 120]
        total_samples = 1
        if spatial == 2:
            data_path = './dataset/tangaroa/down/' 
            downsample_factor = 1
        elif spatial == 1:
            data_path = './dataset/tangaroa/' 
            downsample_factor = 8
    elif dataset == 'bubble':
        ori_dim = [640, 256, 256]
        total_samples = 1
        if spatial == 1:
            data_path = './dataset/bubble/' 
            downsample_factor = 32
    elif dataset == 'halfcy':
        ori_dim = [640, 240, 80]
        total_samples = 1
        if spatial == 2:
            data_path = './dataset/halfcy/down/' 
            downsample_factor = 4
        elif spatial == 1:
            data_path = './dataset/halfcy/' 
            downsample_factor = 16  
    elif dataset == 'combustion':
        ori_dim = [480, 720, 120]
        total_samples = 1
        if spatial == 2:
            data_path = './dataset/combustion/down/' 
            downsample_factor = 8
        elif spatial == 1:
            data_path = './dataset/combustion/' 
            downsample_factor = 32 
    elif dataset == 'YOH':
        ori_dim = [480, 720, 120]
        total_samples = 1
        if spatial == 2:
            data_path = './dataset/YOH/down/' 
            downsample_factor = 8
        elif spatial == 1:
            data_path = './dataset/YOH/' 
            downsample_factor = 32 
        elif spatial == 4:
            data_path = './dataset/YOH/down/four/' 
            downsample_factor = 2 
